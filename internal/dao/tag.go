...
// UpdateTag func (d *Dao) UpdateTag(id uint32, name string, state uint8, modifiedBy string) error {
//	tag := model.Tag{
//		Name:  name,
//		State: state,
...
func (d *Dao) DeleteTag1(id uint32) error {
	tag := model.Tag{Model: &model.Model{ID: id}}
	return tag.Delete1(d.engine)
}
